...
flowchart TB
  ...
  plugin["cw_api3d_charts.dll<br/>plugin_x64_init returns false — stays loaded"]
...
flowchart TB
  ...
  drv["cw_api3d_charts_driving<br/>optional: skipped if CUSTOM_QT_PATH empty"]
  comp["cw_api3d_charts_composition"]
  dll["cw_api3d_charts.dll"]
